        ...
        {stage !== "result" ? (
          ...
          >
            ...
            <p className="mt-sm text-body-lg text-text-secondary">
              Drop in a photo from Pinterest, a magazine, anywhere — we&apos;ll
              find the closest version using clothes you already own.
            </p>
            ...
            <Divider label="or paste an image link" className="my-2xl" />
          ...
          result && (
            ...
            >
                ...
                <section className="mt-4xl">
                  ...
                  <ul className="flex flex-col gap-md">
                    {result.missingPieces.map((piece) => (
                      <li
                        key={piece.style}
                        className="flex items-start gap-lg rounded-xl border border-border bg-surface p-xl shadow-md"
                      >
                        <span
                          aria-hidden
              ...
              <CalloutCard icon={<Sparkles />} className="mt-4xl">
